...
GGSPenny -g lib/libTestGeometry.so -gd macros/geo.mac -d macros/p_15.mac -ro test.root && \
exe/Digitization test.root digit.root && \
#exe/DataAnalysis digit.root histos.root 15 10 0.5 && \
